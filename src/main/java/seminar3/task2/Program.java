...
import static seminar3.task2.ToDoListApp.*;

public class Program {
    public static void main(String[] args) {
        List<ToDoVers2> tasks;
    ...
    static List<ToDoVers2> prepareTasks() {
        ArrayList<ToDoVers2> list = new ArrayList<>();
        list.add(new ToDoVers2("Сходить в магазин за продуктами "));
        list.add(new ToDoVers2("Погулять с собакой"));
        list.add(new ToDoVers2("Заменить лампочку"));
        return list;
    }
}
